import 'package:etherwallet/blocs/wallet/wallet_event.dart';
...
class WalletBloc extends Bloc<WalletEvent, WalletState> {
  ...
  ValueNotifier<bool> balanceUpdateComplete;
  ...
  Future<bool> refreshBalance() async {
    balanceUpdateComplete = ValueNotifier(false);
    add(UpdateBalance(''));
    return balanceUpdateComplete.value;
  }
  ...
  Stream<WalletState> mapEventToState(WalletEvent event) async* {
    ...
    if (event is InitialiseWallet) {
      ...
      if (currentState is WalletStateUpdated) {
        ...
        balanceUpdateComplete?.value = true;
      }
    }
  }
}
